...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <h1 class="navbar-brand">
                        <a href="#body">
                            <img src="css/img/logo.png" alt="Kasper Logo">
                        </a>
                    </h1>
                    <!-- /logo -->
        ...
        <section id="home">     
            <div id="home-carousel" class="carousel slide" data-interval="false">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('css/img/slider/bg2.jpg')" >
                    ...
                    <div class="item" style="background-image: url('css/img/slider/bg2.jpg')">                
                        <div class="carousel-caption">
                    ...
                    <div class="item" style="background-image: url('css/img/slider/bg3.jpg')">                 
                         <div class="carousel-caption">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 wow fadeInLeft">
                        <div class="media">
                            <a href="#" class="pull-left">
                                <img src="css/img/icons/monitor.png" class="media-object" alt="Monitor">
                            </a>
                    ...
                    <div class="col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="media">
                            <a href="#" class="pull-left">
                                <img src="css/img/icons/cog.png" alt="Cog">
                            </a>
                            <div class="media-body">
                                <h3>Vorem amet intuitive</h3>
                                <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Curabitur aliquet quam.</p>
                    ...
                    <div class="col-md-6 col-sm-12 wow fadeInLeft">
                        <div class="media">
                            <a href="#" class="pull-left">
                                <img src="css/img/icons/ruler.png" alt="Ruler">
                            </a>
                            <div class="media-body">
                                <h3>Vorem amet intuitive</h3>
                                <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Curabitur aliquet quam.</p>
                    ...
                    <div class="col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="media">
                            <a href="#" class="pull-left">
                                <img src="css/img/icons/camera.png" alt="Camera">
                            </a>
                            <div class="media-body">
                                <h3>Vorem amet intuitive</h3>
                                <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Curabitur aliquet quam.</p>
        ...
        <section id="service-bottom">
            <div class="container">
                    <div class="mobile-device">
                       <img data-wow-delay="0.2s" class="img-responsive black  wow fadeInLeftBig" src="css/img/icons/iphone-black.png" alt="iPhone Black">
                        <img data-wow-delay="0.5s" class="img-responsive white  wow fadeInLeftBig" src="css/img/icons/iphone-white.png" alt="iPhone White">
                    </div>
        ...
        <section id="portfolio">
            ...
            <nav class="project-filter clearfix text-center wow fadeInLeft"  data-wow-delay="0.5s">
                <ul class="list-inline">
                    <li><a href="css/javascript:;" class="filter" data-filter="all">All</a></li>
                    <li><a href="css/javascript:;" class="filter" data-filter=".app">App</a></li>
                    <li><a href="css/javascript:;" class="filter" data-filter=".photography">Photography</a></li>
                    <li><a href="css/javascript:;" class="filter" data-filter=".web">Web</a></li>
                    <li><a href="css/javascript:;" class="filter" data-filter=".print">Print</a></li>
                </ul>
            </nav>
            ...
            <div id="projects" class="clearfix">
                ...
                <figure class="mix portfolio-item app">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-1.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-1.jpg" title="Title One" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                ...
                <figure class="mix portfolio-item photography">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-2.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-2.jpg" title="Title Two" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item web">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-3.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-3.jpg" title="Title Three" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item print">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-4.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-4.jpg" title="Title Four" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item app">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-4.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-4.jpg" title="Title Five" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item photography">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-1.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-1.jpg" title="Title Six" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item web app">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-2.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-2.jpg" title="Title Seven" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                ...
                <figure class="mix portfolio-item print web">
                    <img class="img-responsive" src="css/img/portfolio/portfolio-3.jpg" alt="Portfolio Item">
                    <a href="css/img/portfolio/portfolio-3.jpg" title="Title Eight" rel="portfolio" class="fancybox"><span class="plus"></span></a>
                    <figcaption class="mask">
                        <h3>Awesome Image</h3>
                        <span>Photography</span>
                    </figcaption>
                        ...
                        <div id="testimonial">
                            ...
                            <div class="tst-item clearfix">
                                <div class="tst-single clearfix">
                                    <img src="css/img/client/1.jpg" alt="Client" class="img-circle">
                                ...
                                <div class="tst-single clearfix">
                                    <img src="css/img/client/2.jpg" alt="Client" class="img-circle">
                                    <div class="tst-content">
                                        <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt.</p>
                                        <span>John Doe,CEO</span>
                                    </div>
                            ...
                            <div class="tst-item">
                                <div class="tst-single clearfix">
                                    <img src="css/img/client/3.jpg" alt="Client" class="img-circle">
                                    <div class="tst-content">
                                        <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt.</p>
                                        <span>John Doe,CEO</span>
                                    </div>
        ...
        <!-- main jQuery -->
        <script src="css/js/vendor/jquery-1.11.1.min.js"></script>
        <!-- Bootstrap -->
        <script src="css/js/bootstrap.min.js"></script>
        <!-- jquery.nav -->
        <script src="css/js/jquery.nav.js"></script>
        <!-- Portfolio Filtering -->
        <script src="css/js/jquery.mixitup.min.js"></script>
        <!-- Fancybox -->
        <script src="css/js/jquery.fancybox.pack.js"></script>
        <!-- Parallax sections -->
        <script src="css/js/jquery.parallax-1.1.3.js"></script>
        <!-- jQuery Appear -->
        <script src="css/js/jquery.appear.js"></script>
        <!-- countTo -->
        <script src="css/js/jquery-countTo.js"></script>
        <!-- owl carousel -->
